...
?>
    <div class="container">
        ...
        <div class="d-flex flex-row p-2 flex-wrap">
            <form method="get" action="index?" class="text-start">
                ...
                <button type="submit" class="h5  p-1 px-4 bg-white blue-font rounded-pill border border-0" name="myListings"  value="3">Ended</button>
    ...
    <div class="rounded-3 p-3">
        ...
        <p class="h2 p-4 blue-font">Your Ended Listings</p>
                ...
                <div class="p-5">
                    <div class="container h4">
                        <form method="get" action="index?" class="text-start row">
                            <div class="lead"> There are no Ended Listings yet!
